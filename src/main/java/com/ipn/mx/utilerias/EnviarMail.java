...
public class EnviarMail {
    public void enviarCorreo(String destinatario, String asunto, String mensaje){
        try {
            ...
            p.setProperty("mail.smtp.user", "mendicantbias096@gmail.com");
            ...
            elMensaje.addRecipient(Message.RecipientType.CC, new InternetAddress("mendicantbias096@gmail.com"));
    ...
    public void main (String[] args){
        ...
        String destinatario = "mendicantbias096@gmail.com";
